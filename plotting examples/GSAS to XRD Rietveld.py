...
# Grab data
filename = r'G:\My Drive\teaching\workshop slides\Ceramic_Rietveld_Refinement\refinement examples\90Al2O3_10Si\refinement\refinement.csv'
...
yticks = np.arange(0, 11000, 2000) #adjust these as needed
plt.minorticks_on()
...
plt.text(3.2, 5000, 'Al$_2$O$_3$=97wt%') #adjust as needed
plt.text(3.2, 4000, 'Si=3wt%') #adjust as needed
...
output_dir = r'G:\My Drive\teaching\workshop slides\Ceramic_Rietveld_Refinement\refinement examples\90Al2O3_10Si\refinement'
os.makedirs(output_dir, exist_ok=True)

# Export figure
plt.savefig(os.path.join(output_dir, 'XRD_Reitveld.png'), dpi=300, bbox_inches="tight")
